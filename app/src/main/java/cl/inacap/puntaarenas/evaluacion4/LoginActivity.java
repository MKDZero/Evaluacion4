...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void verifyFromSQLite() {
        ...
        if (!validacion.isInputEditTextFilled(textInputEditTextPassword, textInputLayoutPassword, getString(R.string.mensaje_error_email))) {
            return;
        }
        ...
        if (databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim()
            ...
            Intent accountsIntent = new Intent(activity, DesplegableActivity.class);
            ...
            Snackbar.make(nestedScrollView, getString(R.string.error_email_contraseña), Snackbar.LENGTH_LONG).show();
        }
    }
